import { PUBLIC_THEMES_ENDPOINT, PUBLIC_CONTENT_PAGE_ENDPOINT } from '$env/static/public';
...
export async function load({ fetch }) {
	try {
		...
		return {
			...
			title: 'Over ons',
			description:
				'Leer meer over het Healthy Urban Living Lab, onze missie, visie en het team dat zich inzet voor innovatieve stedelijke oplossingen.'
		};
	} catch (error) {
